...
bert = BertModel.from_pretrained(r"E:\badou\项目材料准备\pretrain_models\bert-base-chinese", return_dict=False)
...
class DiyBert:
    ...
    def __init__(self, state_dict):
        ...
        self.num_layers = bert.config.num_hidden_layers  # 注意这里的层数要跟预训练config.json文件中的模型层数一致
